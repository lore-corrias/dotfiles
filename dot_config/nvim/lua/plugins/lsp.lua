...
local masonlsp = {
  {
    ...
    keys = {
      { "<leader>a", function() vim.lsp.buf.code_action() end, desc = "Open code actions" },
      { "<leader>r", function() vim.lsp.buf.rename() end, desc = "Open diagnostics" },
      { "<leader>d", function() vim.diagnostic.open_float() end, desc = "Open diagnostics" },
      { "<leader>h", function() vim.diagnostic.hover() end, desc = "Open hover menu" },
    }
  }
}
